import {
  ...
  export function WindSpeedAlert() {
    return (
      <Card
        className={cn(
          "transition-all duration-500 w-full p-6 flex flex-col",
        ...
        <CardContent className="p-0 flex-grow flex flex-col justify-between">
          <div className="space-y-6 mt-4">
            <div className="flex items-center justify-between">
              <span className="text-gray-700">Limite: {limite} kmh</span>
            </div>
          ...
          {isHighWind && (
            <Alert className="bg-red-200 border-red-400 p-3 mt-4">
              ...
              <AlertDescription className="text-red-800 ml-2">
                Alerta de vento forte! A velocidade atual do vento excede o limite
                de segurança.
              </AlertDescription>
            </Alert>
          )}
